...
\includegraphics[scale=0.5]{assets/wines-ontology-onto-pop-temp-var-exp.pdf}
\end{subfigure} \hspace{0.2cm}
\begin{subfigure}{0.5\textwidth} \centering
    \caption{CASE Ontology}
    \label{fig:new-case-temp-variation}
\includegraphics[scale=0.5]{assets/case-uco-owl-trafficking-onto-pop-temp-var-exp.pdf}
\end{subfigure}
