...
\begin{subfigure}{\textwidth} \centering
    ...
    \includegraphics[scale=0.4]{assets/wines-ontology-onto-pop-temp-var-exp.pdf}
\end{subfigure} \hspace{0.2cm}
\begin{subfigure}{\textwidth} \centering
    \caption{CASE Ontology}
    \label{fig:new-case-temp-variation}
    \includegraphics[scale=0.4]{assets/case-uco-owl-trafficking-onto-pop-temp-var-exp.pdf}
\end{subfigure}
